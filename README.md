...
Интерактивный dashboard структуры организации. Проект реализуется поэтапно; сейчас готов **Step 3**: realtime-патчи SSE, инкрементальные агрегаты и интерактивные состояния.
